let _data={
    ...
    channelPage(channelItem){
        ...
        //version=12.94.20247
        let requestUrl=`https://mesh.if.iqiyi.com/portal/lw/videolib/data?uid=2031491668&channel_id=${channelItem.id}&page_id=${pageNum}&filter=%7B%22mode%22%3A%22${sort}%22%7D`;
